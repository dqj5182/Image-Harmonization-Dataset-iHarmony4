...
### Apply a pre-trained DoveNet model (This is important!!!!)
...
For HCOCO
```bash
python test.py --dataset_root ../iHarmony4/HCOCO --name dovenet_pretrain --model dovenet --dataset_mode iharmony4 --netG s2ad --is_train 0  --norm batch --no_flip --preprocess none --num_test 7404
```
For HAdobe5k
```bash
python test.py --dataset_root ../iHarmony4/HAdobe5k --name dovenet_pretrain --model dovenet --dataset_mode iharmony4 --netG s2ad --is_train 0  --norm batch --no_flip --preprocess none --num_test 7404
```
For HFlickr
```bash
python test.py --dataset_root ../iHarmony4/HFlickr --name dovenet_pretrain --model dovenet --dataset_mode iharmony4 --netG s2ad --is_train 0  --norm batch --no_flip --preprocess none --num_test 7404
```
For Hday2night
```bash
python test.py --dataset_root ../iHarmony4/Hday2night --name dovenet_pretrain --model dovenet --dataset_mode iharmony4 --netG s2ad --is_train 0  --norm batch --no_flip --preprocess none --num_test 7404
```
